          ...
          {sidebarOpen && (
            <aside className="dashboard-sidebar">
              ...
              <div className="sidebar-settings">
                <Link to="/Setting" className="sidebar-btn settings-btn">
                  <svg
